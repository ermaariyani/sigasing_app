...
if (isset($_GET['id'])) {
    ...
    if (isset($row['id'])) {
        ...
        if (isset($_POST['button_update'])) {
            $insertSql = "INSERT INTO bagian_karyawan SET bagian_id=?, karyawan_id=?, tanggal_mulai=?";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nik" id="nik" value="<?php echo $row['nik'] ?>" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="handphone">Handphone</label>
                                <input type="text" class="form-control" name="handphone" id="handphone" value="<?php echo $row['handphone'] ?>" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nama_lengkap">Nama Lengkap</label>
                        <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" value="<?php echo $row['nama_lengkap'] ?>" disabled>
                    </div>
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-6">
